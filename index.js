...
setInterval(() => {
  ...
  // workplaces.workplaces.keys().state

  // if (workplaces.workplaces.keys().state == 'notavailable') {
  //   workplaces.workplaces.keys().state = 'notavailable'
  // } else if (workplaces.workplaces.keys().state = 'available') {
  //   workplaces.workplaces.keys().state = 'available'
  // }
  // else { workplaces.workplaces.keys().state = 'offline' }
